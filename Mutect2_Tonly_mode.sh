...
BAM_DIR=./02_BAM
MT_DIR=./04_MT3
FUNCO_DIR=./05_FUNCTO3
for T in FSN22T
do
$GATK/gatk --java-options "-Xmx4g" Mutect2 -pon $DB/somatic-b37_Mutect2-exome-panel.vcf -R $DB/human_g1k_v37.fasta -I $BAM_DIR/$T\_b37.bam --callable-depth 20 --intervals $DB/SureselectV5.list --f1r2-tar-gz $MT_DIR/$T\.tar.gz --germline-resource $DB/af-only-gnomad.raw.sites.b37.vcf.gz -O $MT_DIR/$T\.vcf 
